...
data class TaskInfo(
    val key:            String,
    val label:          String,
    val status:         String,  // "pending" | "running" | "completed" | "failed" | "retrying" | "skipped"
    val runtimeSeconds: Int = 0
)

/**
 * Full pipeline status parsed from /api/state endpoint.
 */
data class PipelineStatus(
    ...
    companion object {
        ...
        fun error(message: String) = PipelineStatus(isLoading = false, errorMessage = message)
    }
